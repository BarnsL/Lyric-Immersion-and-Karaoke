...
SONGS = [
    ...
    # ── Rammstein (German — main line + English translation) ──
    ("Du Hast", "Rammstein", True),
    ("Sonne", "Rammstein", True),
    ("Ich Will", "Rammstein", True),
    ("Mein Herz Brennt", "Rammstein", True),
    ("Deutschland", "Rammstein", True),
    ("Engel", "Rammstein", True),
    ("Feuer Frei!", "Rammstein", True),
    ("Amerika", "Rammstein", True),
    ("Rosenrot", "Rammstein", True),
    ("Mutter", "Rammstein", True),
    ("Links 2 3 4", "Rammstein", True),
    ("Haifisch", "Rammstein", True),
    ("Mein Teil", "Rammstein", True),
    ("Radio", "Rammstein", True),
    ("Zeit", "Rammstein", True),
    ("Du Riechst So Gut", "Rammstein", True),
    ("Keine Lust", "Rammstein", True),
    ("Ohne Dich", "Rammstein", True),
    ("Sehnsucht", "Rammstein", True),
    ("Benzin", "Rammstein", True),

    # ── t.A.T.u. (Russian + English — transliteration + translation) ──
    ("All The Things She Said", "t.A.T.u.", True),
    ("Not Gonna Get Us", "t.A.T.u.", True),
    ("All About Us", "t.A.T.u.", True),
    ("Gomenasai", "t.A.T.u.", True),
    ("30 Minutes", "t.A.T.u.", True),
    ("How Soon Is Now?", "t.A.T.u.", True),
    ("Loves Me Not", "t.A.T.u.", True),
    ("Friend Or Foe", "t.A.T.u.", True),
    ("Clowns (Can You See Me Now?)", "t.A.T.u.", True),
    ("Sacrifice", "t.A.T.u.", True),
    ("Stars", "t.A.T.u.", True),
    ("Malchik Gay", "t.A.T.u.", True),
    ("Я сошла с ума", "t.A.T.u.", True),
    ("Нас не догонят", "t.A.T.u.", True),
    ("Полчаса", "t.A.T.u.", True),
    ("Я твоя не первая", "t.A.T.u.", True),
    ("Простые движения", "t.A.T.u.", True),
